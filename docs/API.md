...
- `displayControlsDefault`, boolean (default: `true`): The default value for `controls`. For example, if you would like all controls to be _off_ by default, and specify an allowed list with `controls`, use `displayControlsDefault: false`.
