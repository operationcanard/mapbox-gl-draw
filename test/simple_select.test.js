...
test("simple_select", (t) => {
  ...
  t.test("simple_select - box select over no points", (t) => {
    ...
    afterNextRender(() => {
      ...
      afterNextRender(() => {
        t.equal(
          getFireArgs().filter((arg) => arg[0] === "draw.selectionchange")
            .length,
          0,
  ...
  t.test("simple_select - drag every feature type", (t) => {
    ...
    afterNextRender(() => {
      ...
      map.fire(
        "mousemove",
        makeMouseEvent(startPosition[0] + 25, startPosition[1] + 25, {
          buttons: 1,
        })
      );
      map.fire(
  ...
  t.test(
    ...
    (t) => {
      ...
      afterNextRender(() => {
        ...
        map.fire(
          "touchstart",
          makeTouchEvent(startPosition[0], startPosition[1])
        );
        setTimeout(() => {
