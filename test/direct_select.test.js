...
test("direct_select", (t) => {
    ...
    (st) => {
      ...
      afterNextRender(() => {
        ...
        afterNextRender(() => {
          ...
          st.deepEqual(afterTrash.geometry.coordinates, [
            [0, 0],
            [10, 0],
            [20, 0],
            [30, 0],
    ...
    (st) => {
      ...
      afterNextRender(() => {
        ...
        afterNextRender(() => {
          map.fire(
            "mousedown",
            makeMouseEvent(clickAt[0] + 15, clickAt[1] + 15)
          );
          map.fire(
            "mousemove",
            makeMouseEvent(clickAt[0] + 30, clickAt[1] + 30, { buttons: 1 })
          );
    ...
    (st) => {
      ...
      afterNextRender(() => {
        ...
        afterNextRender(() => {
          ...
          map.fire(
            "mousedown",
            makeMouseEvent(startPosition[0], startPosition[1])
          );
          map.fire(
            "mousemove",
            makeMouseEvent(startPosition[0] + 15, startPosition[1] + 15, {
              buttons: 1,
            })
          );
          ...
          map.fire(
            "mousemove",
            makeMouseEvent(startPosition[0] + 30, startPosition[1] + 30),
            { buttons: 1 }
          );
          map.fire(
            "mouseup",
  ...
  t.test("direct_select - drag feature if no vertices are selected", (st) => {
    ...
    afterNextRender(() => {
      ...
      map.fire(
        "mousemove",
        makeMouseEvent(centroid[0] + 15, centroid[1] + 15, { buttons: 1 })
      );
  ...
  t.test(
    ...
    (st) => {
      ...
      afterNextRender(() => {
        ...
        map.fire(
          "mousemove",
          makeMouseEvent(endPosition[0], endPosition[1], { buttons: 1 })
        );
