...
test("ui buttons with all options.controls, no attribution control", (t) => {
  ...
  t.ok(
    buttons[1].classList.contains("mapbox-gl-draw_polygon"),
    "second button has polygon class"
  );
  t.ok(
  ...
  t.ok(
    buttons[2].classList.contains("mapbox-gl-draw_point"),
    "third button has point class"
  );
  t.ok(
